...
// Notice in the following function copied from 
// https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch 
// (the best place to copy from since it is the source). It talks 
// two parameters, a URL to send data to and the data in form of 
// object or array to send to the URL. This is a very generic 
// method.
